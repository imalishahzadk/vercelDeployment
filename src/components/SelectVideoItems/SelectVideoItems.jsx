...
const SelectVideoItems = ({ icon, title, onClickHandler }) => {
    ...
    <>
      ...
      {!showProductCard && (
        <>
            ...
            <img src={icon} alt="" className="rounded-md border border-gray-300 border-4" style={imgStyle} />
            <div className="flex justify-center">
                <p className="text-left text-[16] md:text-1xl font-medium my-2 md:my-3 ml-4">
                    {title}
                </p>
            </div>
            <div className="h-7 text-[20] text-black/80" style={paraStyle}>
                <p>219 views, 3 weeks ago</p>
            </div>
