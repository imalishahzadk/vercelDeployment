            ...
            <div className="section-container">
                ...
                <img src={UserPic} alt="User" className="uusserImggggg"/>
                    <div className="uusserInfooooo">
                        <h2 className=" UUsserHeadinggggg">George Bellis</h2>
                        <p className="uusserParagraph">Mindful and Well being</p>
                    </div>
                    ...
                    <div className="bbttn-divvvvv grid grid-cols-1 md:grid-cols-1 gap-3 md:gap-5 text-white">
                        ...
                        <h2 className="btn-head">Ebooks</h2>    
                        <button className="bbtn3333">
                            <span className="text">Supplement Ebook</span>
                        </button>                     
                    </div>
 
                    <p className="lliinklead-ppppp">Powered by | <a href="https://example.com" className="font-semibold">linklead</a></p>
            </div>
