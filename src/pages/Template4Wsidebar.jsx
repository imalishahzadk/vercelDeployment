            ...
            <div className="section-container">
                ...
                <img src={UserPic} alt="User" className="uuuserImgggggg"/>
                    <div className="uuuserInfoooooo">
                        <h2 className=" UUUserHeadingggggg">@milan123</h2>
                        <p className="uuuserParagraphh">Model and Lifestyle Blogger</p>
                    </div>
                    ...
                    <div className="bbbtn-divvvvvv grid grid-cols-1 md:grid-cols-1 gap-3 md:gap-5 text-white">
                        <button className="bbb11111">
                            <span className="text">My Ebooks</span>
                        </button>    
                        <button className="bbb22222">
                            <span className="text">My Store</span>
                        </button>
                        <button className="bbb33333">
                    ...
                    <p className="lllinklead-pppppp">Powered by | <a href="https://example.com" className="font-semibold">linklead</a></p>
            </div>
