...
import EbookMiniLanding from "../components/ProductMiniLanding/ProductMiniLanding";
          ...
          {currentStep !== 3 && (
            <div className="flex flex-col md:flex-col">
              <div className="flex flex-col items-start justify-start px-5 py-2 md:p-20 bg-white h-[60vh]">
                ...
                {currentStep === 1 && (
                  <>
                    <p className="text-2xl md:text-3xl ml-11 font-normal">Discount offer Mini Landing Page</p>
                  </>
                )}
              </div>
