            ...
            <div className="section-container">
                ...
                <img src={UserPic} alt="User" className="uuserImggggg"/>
                    <div className="usuerInfooooo">
                        <h2 className=" UUserHeadinggggg">@milan123</h2>
                        <p className="uuserParagraph">Model and Lifestyle Blogger</p>
                    </div>
                    ...
                    <div className="bbtn-divvvvv grid grid-cols-1 md:grid-cols-1 gap-3 md:gap-5 text-white">
                        <button className="bb1111">
                            <span className="text">My Ebooks</span>
                        </button>    
                        <button className="bb2222">
                            <span className="text">My Store</span>
                        </button>
                        <button className="bb3333">
                            <span className="text">My Videos</span>
                        </button>                  
                    </div>
 
                    <p className="llinklead-ppppp">Powered by | <a href="https://example.com" className="font-semibold">linklead</a></p>
            </div>
