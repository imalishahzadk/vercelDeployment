...
import SelectEbookItems from "../components/SelectEbookItems/SelectEbookItems"
          ...
          {currentStep !== 3 && (
            <div className="flex flex-col md:flex-col">
              <div className="flex flex-col items-start justify-start px-5 py-2 md:p-20 bg-white h-[75vh]">
                {currentStep === 1 && (
                  <>
                    <p className="text-2xl md:text-3xl ml-11 font-normal">Select Ebook</p>
                    <p className="my-2 md:my-3 ml-12 max-w-xl text-black/60 text-sm md:text-base font-normal leading-2">
                      Choose from 3 supplements eBooks. Select and continue to view mini landing page with details and registration. Then enter your email to receive it for free.
                    </p>
                    <div className="flex items-center my-2 md:my-3 ml-12 max-w-xs text-black/60 text-sm md:text-base font-normal leading-2">
                      ...
                      <p>Get All the Selected Ebooks?</p>
                    </div>
                  </>
                )}
              </div>
