      ...
      <div className="flex flex-col lg:flex-row w-full h-full overflow-hidden">
        <div className="flex-grow bg-[#f6f7fa] px-2 lg:px-16 pt-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pb-5">
            <h3 className=" template-header text-2xl font-medium">My Page</h3>
            ...
            <div className="section-container">
                ...
                <img src={UserPic} alt="User" className="new-uuuserImgggggg"/>
                    <div className="new-uuuserInfoooooo">
                        <h2 className=" new-UUUserHeadingggggg">George Bellis</h2>
                        <p className="new-uuuserParagraphh">Mindful and Well being</p>
                    </div>
                    ...
                    <div className="new-bbbtn-divvvvvv grid grid-cols-1 md:grid-cols-1 gap-3 md:gap-5 text-white">
                        ...
                        <h2 className="new-btn-heading">Vlogs</h2>
                        ...
                        <button className="new-bbb33333">
                            <span className="text">Supplement Ebook</span>
                        </button>                  
                    </div> 
                    ...
                    <p className="new-lllinklead-pppppp">Powered by | <a href="https://example.com" className="font-semibold">linklead</a></p>
            </div>
